 ...
 * @param username - The inviter's username
 * @param source - Share channel (telegram|x|facebook|sms|link)
 * @returns Play Store URL with referral attribution
 */
export const buildPlayReferralLink = (username: string, source: string = 'link'): string => {
 ...
 * @param username - The inviter's username
 * @param source - Share channel tag appended as query param
 * @returns Web registration URL
 */
export const buildWebReferralLink = (username: string, source?: string): string =>
 ...
 * @param username - The inviter's username
 * @param source - Share channel (tags both links)
 * @returns Ready-to-share message
 */
export const buildReferralMessage = (username: string, source?: string): string => [
