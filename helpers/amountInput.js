 ...
 * @param {string} text - Raw TextInput value, e.g. "10,50".
 * @param {number} [maxDecimals=2] - Decimal places to keep (8 for crypto amounts).
 * @returns {string} Sanitized value, e.g. "10.50".
 */
export function sanitizeAmountInput(text, maxDecimals = MAX_DECIMAL_PLACES) {
 ...
 * @param {string} text - Raw or sanitized amount string.
 * @returns {number} Parsed amount, or 0 when not a number.
 */
