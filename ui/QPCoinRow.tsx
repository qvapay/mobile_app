 ...
 *
 * @param props
 * @param props.coin - Coin from `coinsApi` (name, logo, price, network, fee_in/out, min_in/out).
 * @param props.amount - Importe a convertir para la cifra de la derecha.
 * @param props.direction - Selecciona fee_in/min_in vs fee_out/min_out. Default 'in'.
 * @param props.showFees - Oculta condiciones y conversión (modo P2P: solo identidad). Default true.
 */
const QPCoinRow = ({ coin, amount = '', direction = 'in', showFees = true }: QPCoinRowProps) => {
	...
	const priceNum = parseFloat(coin.price as string) || 0
