    ...
    <View style={[styles.offerCard, { backgroundColor: theme.colors.surface }]}>
      ...
      <View style={styles.offerHeader}>
        <View style={styles.typeContainer}>
          <Text style={[styles.typeText, { color: theme.colors.primaryText }]}>
      ...
      <View style={{ marginBottom: 6 }}>
        <View style={[styles.amountRow, { marginLeft: 2 }]}>
          ...
          <Text
            style={[
              textStyles.h6,
              { color: theme.colors.primaryText, fontWeight: '200' }
            ]}
          >
            x
          </Text>
          <Text style={[textStyles.h3, { color: theme.colors.primaryText }]}>
            {offer.receive}
          </Text>
        </View>
        <View style={styles.coinRow}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 2 }}>
            ...
            <Text
              style={[
                textStyles.h6,
                { color: theme.colors.primaryText, fontWeight: '400' }
              ]}
            >
      ...
      <View style={styles.messageRow}>
        ...
        <QPButton
          ...
          style={{
            backgroundColor:
              offer.type === 'buy' ? theme.colors.danger : theme.colors.success,
            width: 75,
            height: 30,
            borderRadius: 5,
            paddingHorizontal: 5,
