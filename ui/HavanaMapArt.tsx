...
/** Colores resueltos por modo que CashDeliveryCard construye para el mapa. */
export type HavanaMapPalette = {
	water: string
	land: string
	coast: string
	road: string
...
type HavanaMapArtProps = {
	palette: HavanaMapPalette
}
 ...
 *
 * @param props
 * @param props.palette - Mode-resolved colors from CashDeliveryCard:
 *   water, land, coast, road, roadMajor, roadW, roadMajorW, accent.
 */
const HavanaMapArt = ({ palette }: HavanaMapArtProps) => (
