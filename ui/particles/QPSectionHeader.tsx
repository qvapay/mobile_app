 ...
 * @param props.subtitle - Action label shown next to the icon.
 * @param props.iconName - FontAwesome6 icon for the action (default 'arrow-right').
 * @param props.onPress - Action tap handler.
 */
type Props = {
	title: string
	subtitle?: string
...
const QPSectionHeader = ({ title, subtitle, iconName = 'arrow-right', onPress }: Props) => {
