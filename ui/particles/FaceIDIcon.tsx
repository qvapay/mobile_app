 ...
 *
 * @param props
 * @param [props.size=24] - Square dimension in px.
 * @param [props.color='#000'] - Stroke color; pass a theme color to blend in.
 */
const FaceIDIcon = ({ size = 24, color = '#000' }: FaceIDIconProps) => (
