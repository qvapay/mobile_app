 ...
 * @param props.icon - FontAwesome6 solid icon for the leading tile.
 * @param props.color - Tile tint (hex); icon color + tile background at low alpha.
 * @param props.screen - Route name pushed on press.
 * @param props.index - Position within the group (corner rounding).
 * @param props.totalItems - Group length (corner rounding).
 * @param props.showBadge - Shows the red dot next to the chevron.
 * @param props.verified - Shows a green check (completed verification).
 * @param props.pill - Short status text rendered as a tinted pill (e.g. "Activo").
 */
...
const SettingsItem = ({ title, icon, color, screen, index, totalItems, navigation, disabled, showBadge = false, verified = false, pill }: Props) => {
