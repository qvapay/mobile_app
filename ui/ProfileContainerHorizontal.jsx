        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 5, gap: 15 }}>
            ...
            <View>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5, marginBottom: 5 }}>
                    <Text style={[textStyles.h3, { marginVertical: 0, paddingVertical: 0 }]}>{user.name || ''}</Text>
                ...
                <Text style={[textStyles.h5, { color: theme.colors.secondaryText, marginVertical: 0, paddingVertical: 0 }]}>@{user.username}</Text>
            </View>
        </View>
    )
}
