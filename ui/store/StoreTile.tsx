...
/** Public marketplace store (only the fields this card reads). */
...
type Props = {
	/** Public store: slug, name, logo, banner, rating_avg, sales_count, product_count, product_images, featured. */
	store: MarketStore
	/** Tap handler. */
	onPress: () => void
	/** Extra tile styles. */
 ...
 */
const StoreTile = ({ store, onPress, style }: Props) => {
