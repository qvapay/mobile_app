 ...
 * @param props.country - Currently selected ISO country code (e.g. 'CU').
 * @param props.countrySearch - Current search query.
 * @param props.onChangeSearch - Search input handler.
