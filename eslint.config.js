...
module.exports = [
	...
	// Idiom del proyecto: catches silenciosos best-effort (`catch (error) { /* … */ }`).
	// El override TS del config RN los marca como error en .ts/.tsx; se exime el
	// parámetro del catch y los identificadores prefijados con `_`.
	{
		files: ['**/*.ts', '**/*.tsx'],
		rules: {
