...
- Historial EVM: el plan gratuito de Etherscan V2 cubre Ethereum y Polygon; BNB Chain y Base exigen plan de pago → Moralis como proveedor de respaldo en qpweb (en curso). Después: BTC.
