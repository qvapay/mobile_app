...
- `config.ts`: la IP dev del backend (`192.168.0.10:3000`) puede necesitar ajuste por máquina. Si no responde en 15s, el build debug cae solo a api.qvapay.com (`api/apiHost.ts`).
