...
import type { ContactsPermissionStatus } from '../../../hooks/useDeviceContacts'
...
const ContactsListHeader = ({ contactsCount, filteredCount, filterQuery, onChangeFilter, error, isSyncing, permissionStatus, isResolvingPermission, onSyncPress, theme, textStyles, containerStyles }: ContactsListHeaderProps) => {
