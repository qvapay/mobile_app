...
type Props = NativeStackScreenProps<RootStackParamList, 'AssistedOrderDetail'>
 ...
 */
const AssistedOrderDetail = ({ route }: Props) => {
		...
		<View style={containerStyles.subContainer}>
			...
			>
				...
				<View style={[...cardStyle, { marginTop: 16 }]}>
					{/* `items` se lee sin guard (a diferencia de la lista, que usa `?.`): el
					    detalle asume que el endpoint siempre lo trae — aserción, no cambio */}
