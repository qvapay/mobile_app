	...
	return (
		<ImageBackground source={require('../../assets/images/welcome/qp-bck.png')} style={{ flex: 1 }}>
			<SafeAreaView style={[containerStyles.subContainer, { justifyContent: 'space-between', backgroundColor: 'transparent' }]}>
				...
				<LinearGradient colors={[theme.colors.background, 'transparent']} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '80%' }} />
				<LinearGradient colors={['transparent', theme.colors.background]} style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '40%' }} />

				<View style={styles.titleContainer}>
					<Text style={textStyles.h1} onLongPress={handleTitleLongPress} delayLongPress={1000}>Bienvenido a QvaPay</Text>
