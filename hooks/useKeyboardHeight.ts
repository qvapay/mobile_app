...
import { Platform, Keyboard, type KeyboardEvent } from 'react-native'
 ...
 *
 * @returns `{ keyboardHeight, keyboardVisible }`
 */
export function useKeyboardHeight(): { keyboardHeight: number, keyboardVisible: boolean } {
