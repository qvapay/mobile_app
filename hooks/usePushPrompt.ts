...
/** Contrato del hook: flags de cada superficie de prompt + acciones. */
export type PushPrompt = {
	isPushEnabled: boolean
	shouldShowPostTxPrompt: boolean
	shouldShowBanner: boolean
	shouldShowRedDot: boolean
	shouldShowOnboardPrompt: boolean
	enablePush: () => Promise<void>
	dismissPostTxPrompt: () => Promise<void>
	dismissBanner: () => Promise<void>
	dismissOnboardPrompt: () => Promise<void>
}
 ...
 *
 * @returns `{ isPushEnabled, shouldShowPostTxPrompt, shouldShowBanner,
 ...
 */
const usePushPrompt = (): PushPrompt => {
